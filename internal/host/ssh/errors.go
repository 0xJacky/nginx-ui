...
var (
	...
	ErrKnownHostsEntryNotFound  = e.New(510011, "known_hosts entry not found: {0}")
	ErrHostKeyConfirmRequired   = e.New(510012, "host key operation requires explicit confirmation")
	ErrHostKeyScanFailed        = e.New(510013, "failed to scan host key: {0}")
	ErrHostKeyAlgorithmMismatch = e.New(510015, "host key algorithm mismatch: expected {0}, got {1}")
)
