...
const notifications: Record<string, { title: () => string, content: (args: any) => string }> = {
  ...
  'Sync Certificate Success': {
    ...
    content: (args: any) => $gettext('Sync Certificate %{cert_name} to %{node_name} successfully', args),
  },
  'Sync Config Error': {
  ...
  'Rename Remote Config Error': {
    ...
    content: (args: any) => $gettext('Rename %{orig_path} to %{new_path} on %{node_name} failed', args),
  },
  'Rename Remote Config Success': {
    title: () => $gettext('Rename Remote Config Success'),
    content: (args: any) => $gettext('Rename %{orig_path} to %{new_path} on %{node_name} successfully', args),
  },
  'Delete Remote Config Error': {
    title: () => $gettext('Delete Remote Config Error'),
    content: (args: any) => $gettext('Delete %{path} on %{node_name} failed', args),
  },
