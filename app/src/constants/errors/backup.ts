export default {
  ...
  4015: () => $gettext('Failed to create backup manifest: {0}'),
  4016: () => $gettext('Failed to create backup manifest signature: {0}'),
  ...
  4804: () => $gettext('Failed to read backup manifest: {0}'),
  4805: () => $gettext('Failed to read backup manifest signature: {0}'),
  4806: () => $gettext('Invalid backup manifest: {0}'),
  4807: () => $gettext('Invalid backup manifest signature'),
  4808: () => $gettext('Backup integrity verification failed'),
  4809: () => $gettext('This backup uses an unsupported legacy format. Please create a new backup with a newer version before restoring.'),
  4810: () => $gettext('Backup manifest is missing required file entry: {0}'),
  4811: () => $gettext('Backup signing key is unavailable'),
