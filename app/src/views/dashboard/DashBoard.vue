  ...
  <div class="grid grid-cols-3 gap-6">
        ...
        <div class="col-span-2 bg-white rounded-lg shadow p-6">
          <div class="flex justify-between items-center mb-4">
            <h2 class="text-lg font-semibold">Geo Location</h2>
            <div class="flex space-x-2">
              <span class="bg-[#00E7C3] text-white px-2 py-1 rounded text-sm">3D</span>
              <span class="bg-gray-100 text-gray-600 px-2 py-1 rounded text-sm">2D</span>
            </div>
          </div>
          <!-- Globe Component Placeholder -->
          <div class="h-[400px] flex items-center justify-center bg-gray-50 rounded">
            <Globe />
          </div>
        </div>
