...
require (
	...
	github.com/huaweicloud/huaweicloud-sdk-go-v3 v0.1.177 // indirect
	...
	github.com/yandex-cloud/go-sdk/services/dns v0.0.19 // indirect
	github.com/yandex-cloud/go-sdk/v2 v2.27.0 // indirect
