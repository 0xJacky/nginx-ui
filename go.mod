...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.62.523 // indirect
	...
	github.com/dnsimple/dnsimple-go v1.3.0 // indirect
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/dnspod v1.0.731 // indirect
